				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode()!=Activity.RESULT_OK) {
							...
							.setAutoCancel(true)
							.setContentTitle("Personal Twitter")
							.setContent(mContentView)
							.setContentIntent(pendingIntent);
							
							// TODO: Send the notification
							NotificationManager mNotification = (NotificationManager) mApplicationContext.getSystemService(Context.NOTIFICATION_SERVICE);
							mNotification.notify(MY_NOTIFICATION_ID,notificationBuilder.build());
